...
namespace WakaSkies.WakaModelBuilder
{
    ...
    public class STLSerializer
    {
        ...
        public string Serialize(WakaModel model)
        {
            ...
            string solidName = "Generated by WakaSkies 1.1.0";
        ...
        /// <summary>
        /// Serialize a WakaModel into a binary stream.
        /// </summary>
        /// <param name="model">The WakaModel to serialize.</param>
        /// <returns>The memory stream the bytes are written to.</returns>
        public MemoryStream SerializeBinaryStream(WakaModel model)
        {
            // https://www.fabbers.com/tech/STL_Format
            // https://en.wikipedia.org/wiki/STL_(file_format)
